    ...
    <form method="post" name="frm">
      <table class="table" align="center" border="0">
        ...
        for ($x = 0; $x <= sizeof($promotionlist)-1; $x++) {
          ...
          <a href="'. base_url("admin/view_promotion/"). $promotionlist[$x]->id .'" class="btn btn-default"><em class="fa fa-eye"></em></a>
          <a href="'. base_url("admin/edit_promotion/"). $promotionlist[$x]->id .'" class="btn btn-default"><em class="fa fa-pencil"></em></a>
          <a href="'. base_url("admin/delete_promotion/"). $promotionlist[$x]->id .'" onClick="return confirm(\'Are you sure you want to delete?\')" class="btn btn-danger"><em class="fa fa-trash"></em></a>
          </td>';
          echo '</tr>';
        }
