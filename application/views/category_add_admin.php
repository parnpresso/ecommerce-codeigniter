...
<body>
  ...
  <div class="container-fluid">
    <form class="form-horizontal" action="<?php echo base_url('admin/add_category_validation');?>" method="post" id="register-form">
      <fieldset>
        <!-- Form Name -->
        <legend style="text-align:center"><h2>เพิ่มประเภทสินค้า</h2></legend>
        <br />
        <?php
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
                <a href="<?php echo base_url('admin/category');?>" class="btn btn-danger" style="float:left;">กลับ</a>
