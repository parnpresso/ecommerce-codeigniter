...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-12">
      ...
      <center><h4>รายงานสรุปยอดขายขายดี</h4></center><br>
      ...
      <center>
        <?php
          ...
          for ($y = 0; $y < sizeof($report); $y++) {
            ...
            echo '<th>'.(int)$report[$y]->product_price * (int)$report[$y]->product_quantity.'</th>';
            echo '</tr>';
            //echo $sum_each_cate.',';
            $sum_each_cate = $sum_each_cate + ((int)$report[$y]->product_price * (int)$report[$y]->product_quantity);
            //echo "--------------". $x.$y;
          }
          echo '</tbody>';
          echo '</table>';
