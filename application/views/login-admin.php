...
<body>
  ...
  <div class="login">
    <h1>Admin</h1>
    <form name="form1" method="post" action="<?php echo base_url(). "admin/validation"; ?>">
      ...
      <?php
       ...
       <input type="submit" name="Submit" class="btn-primary" value="Login"></input>
    </form>
       <!--a href="<?php //echo base_url(). "admin/register"; ?>"><input type="submit" class="btn-success" value="Register"></input></a-->
  </div>
